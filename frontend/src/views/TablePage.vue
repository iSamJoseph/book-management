...
<template>
  <div class="container-fluid p-5 maintable">
    <div class="mb-3">
      <RouterLink class="text-decoration-none text-success" to="/Addbook">Add New Book</RouterLink>
    </div>

    <div>
      <div class="spin" v-if="store.getters.getLoader">
        <div class="p-2 mb-2"><Spinners /></div>
      </div>
      <table class="table">
        ...
        <tbody v-for="(item, index) in store.state.bookDetails" :key="index">
          <tr>
            ...
            <td>
              ...
              <RouterLink
                class="text-decoration-none"
                :to="{ name: 'modals', params: { id: item._id } }"
                >Delete</RouterLink
              >
            </td>
          </tr>
